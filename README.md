...
@EnableJpaAuditing
@EnableJpaRepositories(basePackages = "com.tailoring.yewu.repository", transactionManagerRef = "jpaTransactionManager")
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("com.tailoring.yewu.entity");
 ...
 * </p>
 *
 * @package: com.tailoring.yewu.entity
 * @description: 用户实体类
 * @author: yangkai.shen
...
public class UserDaoTest extends SpringBootDemoOrmJpaApplicationTests {
    ...
    public void testSave() {
        ...
        User testSave3 = User.builder().name("testSave3").password(SecureUtil.md5("123456" + salt)).salt(salt).email("testSave3@tailoring.com").phoneNumber("17300000003").status(1).lastLoginTime(new DateTime()).build();
    ...
    private void initData() {
        ...
        for (int i = 0; i < 10; i++) {
            String salt = IdUtil.fastSimpleUUID();
            int index = 3 + i;
            User user = User.builder().name("testSave" + index).password(SecureUtil.md5("123456" + salt)).salt(salt).email("testSave" + index + "@tailoring.com").phoneNumber("1730000000" + index).status(1).lastLoginTime(new DateTime()).build();
            userList.add(user);
        }
