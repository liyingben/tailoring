...
public enum StatusEnum {
	...
	TAILORING_ORDER_STATUS_START(2, "开始创建计划"),
	TAILORING_ORDER_STATUS_OVER(3, "开始创建计划"),
	TAILORING_ORDER_STATUS_FINISH(4, "计划创建完成"),


	//工单状态状态
	TAILORING_TASK_STATUS_DELETE(-1, "删除状态"),
	TAILORING_TASK_STATUS_DEFAULT(1, "正常状态"),
	TAILORING_TASK_STATUS_START(2, "开始任务"),
	TAILORING_TASK_STATUS_SUBMIT(3, "提交任务"),
	TAILORING_TASK_STATUS_PASS(5, "通过完成"),
	TAILORING_TASK_STATUS_NOPASS(6, "没通过完成");
