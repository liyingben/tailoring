...
public enum ResultType {
    ...
    DATA_PLAN_QUATITY_OUT_ORDER_VALUE(70100, "计划数量超出订单数额"),
    DATA_PLAN_CHANGE_PIECES_QUANTITY_OUT_ORDER_VALUE(70101, "换片数量超出订单换片"),
    DATA_PLAN_EDIT_STATUS_ERROR(70102, "计划没有在编辑状态"),
    ...
    CREATE_TASK_NO_SELECT_PLAN_ERROR(800001, "请选择裁剪计划"),
    ...
    GROUP_GREATER_THAN_FLOOR_ERROR(800105, "层高错误"),
    GROUP_GREATER_THAN_SUBMIT_ERROR(800106, "请把已保存的计划提交给车间主任审核"),


    EXAMINE_NO_DATA_ERROR(800200, "没有裁剪数据");
